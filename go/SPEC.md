...
- `go/README.md` — overview, install, quickstart.
- `go/docs/commands.md` — concise per-command reference (the "how do I use this" doc, generated from `pg_sandbox help` output or hand-maintained).
- `go/docs/environment.md` — every env var with default, precedence note, and example.
- `go/docs/exit-codes.md` — the table in §8 plus prose for each code.
- `go/docs/examples.md` — end-to-end recipes (single instance; sync replication; logical pub/sub; cluster).
